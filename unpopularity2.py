...
class SpotifyAnalyzer(tk.Tk):
    def __init__(self):
        ...
        # Set up Spotipy authentication with error handling
        try:
    ...
    def _create_menubar(self):
        ...
        command for exporting the least popular album and track data.
        """
        ...
        # "Export Unpopularity..." calls export_unpopularity()
    ...
    def _create_main_layout(self):
        ...
        Charts are set to fill all the available space.
        """
        ...
        # Bind the Enter key to trigger search_artist()
        ...
        # Right PanedWindow for charts (vertical split)
    ...
    def fetch_albums(self):
        """
        Fetches all albums for the selected artist (excluding albums with 'live' in the name).
    ...
    def on_select_album(self, event):
        ...
        Fetches track data for the album (skipping tracks with 'live' in the name)
        ...
        for track in album_tracks:
            ...
            # Skip tracks with "live" in the name
...
def main():
    """
    Entry point of the program. Creates and runs the main application.
    """
    app = SpotifyAnalyzer()
    app.mainloop()
